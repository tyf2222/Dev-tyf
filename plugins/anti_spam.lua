    ...
    if msgs > max_msg then
	  ...
	  if msg.to.type == 'chat' or msg.to.type == 'channel' then
		if username then
			...
			send_large_msg(receiver , "تہۧم ✅آلہۧكہۧشہۧف عہۧن وجہۧود آطہۧفہۧآل 🌞✨ \n تہۧم دفہۧر آلہۧطفہۧل 🏌👶🏻 \n يہۧرجہۧى آتہۧبہۧآع آلہۧقہۧوآنہۧيہۧن ✔️📋\n  تہۧرآ آنہۧيے  سہۧآقہۧط 😒\n لہۧحہۧد لہۧيہۧحہۧآول يہۧفہۧلہۧش  🐸🍷 \n ومہۧيہۧمہۧو مہۧطہۧوريے   🌞✨ \n  قہۧنہۧآة آلہۧمہۧطہۧوريہۧن 🙇🏻🍷 \n  @Ch_Dev  \n #مہۧعہۧرفہۧ وآسہۧم آلہۧطہۧفہۧل 😹🌚 ( @"..username..")  [ "..msg.from.print_name.." ] \n")
		else
